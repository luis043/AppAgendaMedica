...
import static com.agendamedica.app.domain.PacienteAsserts.*;
...
class PacienteResourceIT {
    ...
    void partialUpdatePacienteWithPatch() throws Exception {
        ...
        partialUpdatedPaciente.nombre(UPDATED_NOMBRE).apellidos(UPDATED_APELLIDOS).rut(UPDATED_RUT).email(UPDATED_EMAIL);
